...
h.innerHTML = "<div width='480' height='640' style='background: #fff;position: absolute;top: 20px;left: 20px; padding: 20px; border: 1px solid #777;overflow: auto;' id='ovidsh_display'>OvidSH (<a href='javascript:var h = document.getElementById(\"ovidsh_display\");h.style.display = \"none\";void(0);'>Close this window</a>)<hr/><pre>" + out1 + "<br/><br/>" + out2 + "</pre></div>";